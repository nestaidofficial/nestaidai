...
export function HeroPreview() {
  ...
  return (
    <div className="w-full px-6 sm:px-16 lg:px-24">
      ...
      <div className="rounded-xl border border-black/12 bg-white/95 overflow-hidden shadow-[0_8px_30px_-10px_rgba(0,0,0,0.08)] h-[520px] sm:h-[600px] flex flex-col">

        {/* ── Product tab bar — scrollable on mobile, centered on sm+ ── */}
        <div className="relative flex items-center gap-1 px-4 py-2 border-b border-black/10 bg-[#F8F8F7] shrink-0 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden sm:justify-center">
