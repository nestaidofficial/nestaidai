    ...
    <section className="section-padding">
      <div className="container-max">
        ...
        <div className="grid gap-6 sm:grid-cols-5">
          ...
          <Card className="group overflow-hidden border border-black/15 shadow-black/5 sm:col-span-2 rounded-2xl flex flex-col">
          ...
          <Card className="group overflow-hidden border border-black/15 shadow-black/5 sm:col-span-3 rounded-2xl">
            <CardHeader>
